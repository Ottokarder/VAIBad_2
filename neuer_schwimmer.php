...
<div class="container">
    ...
    <form method="POST" action="neuer_schwimmer.php" class="form">
        <div class="form-group">
            ...
            <input type="text" id="vorname" name="vorname" required value="<?php echo isset($vorname) ? htmlspecialchars($vorname) : ''; ?>">
        </div>

        <div class="form-group">
            <label for="nachname">Nachname:</label>
            <input type="text" id="nachname" name="nachname" required value="<?php echo isset($nachname) ? htmlspecialchars($nachname) : ''; ?>">
        </div>
