...
if (file_exists('includes/header.php')) {
    ...
    <body>';
    echo '<header class="site-header"><div class="header-container"><div class="logo"><a href="/index.php"><h1>VAIBad 2</h1></a></div><nav class="main-nav"><ul><li><a href="/index.php" class="active">Startseite</a></li></ul></nav></div></header>';
