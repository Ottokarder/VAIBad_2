...
if (file_exists('includes/header.php')) {
    ...
    <body>';
    echo '<header class="site-header"><div class="header-container"><div class="logo"><a href="/index.php"><h1>VAIBad 2</h1></a></div><nav class="main-nav"><ul><li><a href="/index.php" class="active">Startseite</a></li><li><a href="/schwimmerliste.php">Schwimmer</a></li><li><a href="/sponsorenliste.php">Sponsoren</a></li><li><a href="/teams.php">Teams</a></li><li><a href="/hauptsponsorenliste.php">Hauptsponsoren</a></li><li><a href="/schwimmleistung_eingeben.php">Schwimmleistung eingeben</a></li><li><a href="/auswertungen.php">Auswertungen</a></li><li><a href="/spendenlisten.php">Spendenlisten</a></li><li><a href="/spenden_sponsoren.php">Spenden (Schwimmer)</a></li></ul></nav></div></header>';
