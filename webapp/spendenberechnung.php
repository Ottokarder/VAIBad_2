...
<div class="container">
    ...
    <form method="POST" action="/VAIBad_2/webapp/spendenberechnung.php" class="form">
        <div class="form-actions">
            ...
            <a href="/VAIBad_2/webapp/spenden_sponsoren.php" class="btn btn-secondary">Ergebnisse ansehen</a>
