...
// Detailseite für einen einzelnen Sponsor.
...
if (!in_array($typ, ['sponsor', 'team', 'hauptsponsor'], true) || $id <= 0) {
    header("Location: /spenden_sponsoren.php");
    exit();
}
...
<div class="container">
    ...
    <div class="action-bar">
        <a href="/sponsor_details.php?typ=<?php echo $typ; ?>&id=<?php echo $id; ?>&export=csv" class="btn btn-primary">Als CSV herunterladen</a>
        <a href="/spenden_sponsoren.php" class="btn btn-secondary">Zurück zu den Sponsoren</a>
